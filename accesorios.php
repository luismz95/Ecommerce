    ...
    <div class="products">
      ...
      <div class="products__item">
        ...
        <article class="product">
          ...
          <img src="IMAGENES/ac4.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$350</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto5</h1>
            <img src="IMAGENES/ac5.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$300</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto6</h1>
            <img src="IMAGENES/ac6.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$250</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto7</h1>
            <img src="IMAGENES/ac7.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$350</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto8</h1>
            <img src="IMAGENES/ac8.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$380</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto9</h1>
            <img src="IMAGENES/ac9.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$200</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto10</h1>
            <img src="IMAGENES/ac10.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$400</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto11</h1>
            <img src="IMAGENES/ac11.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$350</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto12</h1>
            <img src="IMAGENES/ac12.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$280</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto13</h1>
            <img src="IMAGENES/ac13.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$300</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto14</h1>
            <img src="IMAGENES/ac14.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$350</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto15</h1>
            <img src="IMAGENES/ac15.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$450</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto16</h1>
            <img src="IMAGENES/ac16.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$300</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto17</h1>
            <img src="IMAGENES/ac17.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$250</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto18</h1>
            <img src="IMAGENES/ac18.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$300</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto19</h1>
            <img src="IMAGENES/ac19.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$320</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto20</h1>
            <img src="IMAGENES/ac20.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$290</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto21</h1>
            <img src="IMAGENES/ac21.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$400</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto22</h1>
            <img src="IMAGENES/ac22.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$350</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto23</h1>
            <img src="IMAGENES/ac23.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$280</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto24</h1>
            <img src="IMAGENES/ac24.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$200</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto25</h1>
            <img src="IMAGENES/ac25.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$450</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto26</h1>
            <img src="IMAGENES/ac26.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$350</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto27</h1>
            <img src="IMAGENES/ac27.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$320</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto28</h1>
            <img src="IMAGENES/ac28.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$200</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto29</h1>
            <img src="IMAGENES/ac29.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$450</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto30</h1>
            <img src="IMAGENES/ac30.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$300</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto31</h1>
            <img src="IMAGENES/ac31.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$290</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
      ...
      <div class="products__item">
        ...
        <article class="product">
          <h1 class="product__title">Titulo del producto32</h1>
            <img src="IMAGENES/ac32.jpg" alt="" class="prueba">
          <p class="product__text">
            <h2>$290</h2>
            <a class="button js-add-product" href="#" title="Add to cart">
              Agregar al carrito
